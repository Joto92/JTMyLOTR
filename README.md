...
* Possible new Leaders: Sam, Pippin
- - - -
# 2. Leader & Civs
## 2.1. Gondor
Númenorean Son’s: Builders receive an additional charge. Units receive a +5 [ICON_Strength] Combat Strength when in your territory or adjacent to your territory.
### 2.1.1. Leaders
* Aragorn | The Heir of Isildur: Additional Wildcard policy slot.
* (EXTRA) Denethor II | Steward of Gondor: Units receive a +5 Combat Strength bonus on their home continent.
### 2.1.2 Units
* Citadel Guard: Gondor unique anti-cavalry unit. +5 [ICON_Strength] Combat Strength if there is at least one Citadel Guard adjacent.
* Rangers of Ithilien: Gondor unique ranged/recon unit. This unit is invisible unless adjacent enemies are next this units.
* Swan Knights: Gondor unique heavy cavalry unit. +5 Combat Strength when attacking ranged and siege units.
* Gondor Longbowman: Gondor unique ranged unit. +5 Combat Strength when in a district or fort.
### 2.1.3 Buildings
* Heroic Statue: Gives 3 [ICON_Culture] Culture and 1 Points for Great Generals.
* Númenorean Walls: Arnor and Gondor unique building that improve the Medieval Walls.
* Númenorean Tower: Arnor and Gondor unique building available after researching Castles. Gives more defenece, +1 [ICON_Culture] Culture, +1 [ICON_Science] Science and +1 Point for Great Generals.

## 2.2. Rohan
The Mark of the Riders: Receive a second Rohirrim unit each time you train a Rohirrim unit. All Pastures gain 1 [ICON_Culture].
### 2.2.1. Leaders
* Théoden | Glorious Charge: +300% flanking bonus. All Cavalry Units push enemys back if they are victorious in combat. Defenders that cannot retreat suffer additional damage.
* (EXTRA) Eorl the Young | Lord of the Éothéod: May declare war on anyone at war with their allies without warmonger penalties. When at war with a common foe, they and their allies share pillage rewards and share combat experience gains if within 5 tiles.
### 2.2.2 Units
* Rohirrim: Rohan unique cavalry unit. +5 [ICON_Strength] Combat Strength against melee units and heal after defeating an enemy.
* Rohirrim Archer: Rohan unique ranged cavalry unit. Can move after attacking.
...
* Harondor: Your cities earn +15% [ICON_Culture] Culture whenever you are not at war with any civilization.
